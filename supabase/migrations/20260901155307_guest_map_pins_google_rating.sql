-- Follows 20260901155246_recommendations_google_rating.sql: guest_map_pins
-- must return google_rating/google_review_count for the guest UI's new
-- rating badge. Boats return null for both — a boat tour has its own
-- BoatLocal-owned pricing/duration fields, no Google rating concept here.
--
-- DROP then CREATE, not CREATE OR REPLACE — same "cannot change return
-- type of existing function" constraint this function's prior migrations
-- already document.
